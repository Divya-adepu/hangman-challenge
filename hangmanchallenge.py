...
class hangman:
    ...
    word_list = ['stun','apple','comment','systematic','adviser','argument','chemistry','ward','goal','knot','confession','desk','opinion','banana','horoscope','number','paris','dark','girl','association','reserve','shrink','worker','mountain','concept','dead','prestige','family','belief','mobile','trouble','temptation']
